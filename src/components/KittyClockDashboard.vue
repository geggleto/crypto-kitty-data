...
<script>
    ...
    export default {
        ...
        data() {
            ...
            state.kittyClock = '0x06012c8cf97bead5deae237070f9587f8e7a266d';

            return state;
        },
        created() {
            this.profileKitties = [];
            store.loadOtherCKProfile(this.kittyClock, 0);
        },
        methods : {
            fromWei(price) {
            ...
            getUrl() {
                return 'http://dna.cryptokittydata.info//dna/profile/'+this.kittyClock+'/csv';
            }
        }
    }
</script>
